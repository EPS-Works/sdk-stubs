from .definitions import coordinate as coordinate, time as time
...
__all__ = ['NMEA', 'Field', 'Talker', 'DataValidity', 'FixType', 'OperationMode', 'NavigationMode', 'PositionMode', 'Satellite', 'Parser', 'time', 'coordinate']
